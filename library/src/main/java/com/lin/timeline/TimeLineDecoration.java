...
public class TimeLineDecoration extends RecyclerView.ItemDecoration {
    ...
    @IntDef({NORMAL, BEGIN, END, END_FULL, LINE, LINE_FULL, CUSTOM,GREEN})
    ...
    @Nullable
    private Drawable customGreenMarker;
    private int customGreenMarkerRadius;
    ...
    public TimeLineDecoration setCustomGreenMarker(@DrawableRes int resId) {
        return setCustomGreenMarker(getDrawable(resId));
    }

    public TimeLineDecoration setCustomGreenMarker(@NonNull Drawable drawable) {
        customGreenMarker = drawable;
        customGreenMarkerRadius = customMarker.getIntrinsicWidth() / 2;
        return this;
    }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            switch (callback.getTimeLineType(position)) {
                ...
                case GREEN:
                    drawLine(canvas, view.getTop() - topMargin, view.getBottom() + bottomMargin);
                    drawMarkerOrCircle(canvas, view, customGreenMarker, customGreenMarkerRadius);
                    break;
            }
        }
    }
